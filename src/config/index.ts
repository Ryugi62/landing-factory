...
export const ALL_CONFIGS: PageConfig[] = [datemind, padsafe, skinfit, portfolioshield, tapout, test_pipeline_success_01, test_pipeline_success_02, truetailor, invoicenudge]
