      ...
      <section className={`px-6 py-14 sm:py-20 ${bgClass}`}>
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="mt-1">
              <WaitlistForm slug={slug} cta={hero.cta} accent={accent} shareText={config.sharing?.shareText} shareChannels={config.sharing?.channels} referral={config.sharing?.referral} />
            </div>
